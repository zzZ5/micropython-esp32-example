...
def read_config():
    ...
    with open("config.json") as f:
        global config
        config = json.load(f)
        global version, equipment_key, wifi_name, wifi_password, mqtt_user, mqtt_password, mqtt_server, keys, value_skip, post_interval, ntp_host, ntp_interval, temp_maxdif
...
class MyIotPrj:
    ...
    def __init__(self):
        ...
        self.isconn = False
        self.topic_ctl = '{}/{}/response'.format(version, equipment_key).encode()
        self.topic_sta = '{}/{}/{}/{}'
